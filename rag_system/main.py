...
import uuid
from langchain_community.chat_models import ChatOllama  # updated import as per deprecation warning
...
llm = ChatOllama(model="phi")  # Ensure 'phi' model exists or change accordingly
...
def clean_bangla_text(text: str) -> str:
    ...
    # Remove unwanted special chars except Bengali letters, digits, punctuation, and whitespace
